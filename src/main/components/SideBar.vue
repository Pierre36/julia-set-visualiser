...
export default defineComponent({
  ...
  data() {
    return {
      ...
      currentPanel: PANELS_IDS.FUNCTION,
      panels: [
        {
          id: PANELS_IDS.FUNCTION,
          name: "Function",
  ...
  methods: {
    ...
    updateCurrentPanel(newPanel: PANELS_IDS) {
