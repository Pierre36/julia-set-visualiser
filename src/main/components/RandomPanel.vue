  ...
  methods: {
    randomize() {
      this.configuration.randomize({
        functionParameters: {
          functionTypes: this.selectedFunctionTypes,
          minCoefficientsCount: this.coefficientsCount.min,
          maxCoefficientsCount: this.coefficientsCount.max,
          coefficientsParameters: {
            coefficientTypes: this.selectedCoefficientTypes,
            constantParameters: {
              minModulus: this.complexModulus.min,
              maxModulus: this.complexModulus.max,
            },
            circleParameters: {
              centerParameters: {
                minModulus: this.circleCentreModulus.min,
                maxModulus: this.circleCentreModulus.max,
              },
              minRadius: this.radius.min,
              maxRadius: this.radius.max,
              minDuration: this.circleDuration.min,
              maxDuration: this.circleDuration.max,
            },
            lineParameters: {
              startParameters: {
                minModulus: this.startEndModulus.min,
                maxModulus: this.startEndModulus.max,
              },
              endParameters: {
                minModulus: this.startEndModulus.min,
                maxModulus: this.startEndModulus.max,
              },
              minDuration: this.lineDuration.min,
              maxDuration: this.lineDuration.max,
            },
            ellipseParameters: {
              centerParameters: {
                minModulus: this.ellipseCentreModulus.min,
                maxModulus: this.ellipseCentreModulus.max,
              },
              minHalfWidth: this.halfWidth.min,
              maxHalfWidth: this.halfWidth.max,
              minHalfHeight: this.halfHeight.min,
              maxHalfHeight: this.halfHeight.max,
              minRotationAngle: this.rotationAngle.min,
              maxRotationAngle: this.rotationAngle.max,
              minDuration: this.ellipseDuration.min,
              maxDuration: this.ellipseDuration.max,
            },
          },
        },
        minJuliaHue: this.juliaHue.min,
        maxJuliaHue: this.juliaHue.max,
        minJuliaSaturation: this.juliaSaturation.min,
        maxJuliaSaturation: this.juliaSaturation.max,
        minJuliaValue: this.juliaValue.min,
        maxJuliaValue: this.juliaValue.max,
        attractorsParameters: {
          minHue: this.attractorsHue.min,
          maxHue: this.attractorsHue.max,
          minSaturationStrength: this.attractorsSaturationStrength.min,
          maxSaturationStrength: this.attractorsSaturationStrength.max,
          minSaturationOffset: this.attractorsSaturationOffset.min,
          maxSaturationOffset: this.attractorsSaturationOffset.max,
          minValueStrength: this.attractorsValueStrength.min,
          maxValueStrength: this.attractorsValueStrength.max,
          minValueOffset: this.attractorsValueOffset.min,
          maxValueOffset: this.attractorsValueOffset.max,
        },
        minViewportScale: this.viewportScale.min,
        maxViewportScale: this.viewportScale.max,
        viewportCentreParameters: {
          minModulus: this.viewportCentreModulus.min,
          maxModulus: this.viewportCentreModulus.max,
        },
        minIterationsCount: this.iterationsCount.min,
        maxIterationsCount: this.iterationsCount.max,
        minEpsilon: this.epsilon.min,
        maxEpsilon: this.epsilon.max,
        minJuliaBound: this.juliaBound.min,
        maxJuliaBound: this.juliaBound.max,
      });
      this.$emit("change");
    },
  },
