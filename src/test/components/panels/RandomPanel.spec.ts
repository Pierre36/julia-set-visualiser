...
const epsilonMinDefault = 0.0005;
const epsilonMinMin = 0.00001;
const epsilonMaxDefault = 0.0015;
const epsilonMaxMax = 0.1;

const juliaBoundMinDefault = -1;
...
describe("Render", () => {
  ...
  it("renders the advanced settings section correctly", async () => {
    ...
    expect(minMaxInputs[1].vm.$props.step).toBe(0.0001);
    expect(minMaxInputs[1].vm.$props.isIntegerOnly).toBe(false);
